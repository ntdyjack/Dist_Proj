...
threeplot_lims <- list(
  c(0.07,0.32,0.15,0.70),
  c(0.40,0.65,0.15,0.70),
  c(0.71,0.96,0.15,0.70)
)
...
pdf("/users/ndyjack/Dist_Proj/figures_final/figure_2.2.pdf",width=12,height=6)
for(i in 2){
  #dist legend
  plot.new()
  par(new = "TRUE",plt = c(0.05,1.00,0.70,0.95),las = 1,cex.axis = 1)
  plot.new()
  ...
  for(j in 1:ncol(metrics_pairs)){
    ...
    box()
    points(x=xval,y=yval,col=col_labs,cex=1.5,pch=pch_labs)
