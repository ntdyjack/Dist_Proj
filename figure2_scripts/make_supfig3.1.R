...
files_clvec <- as.vector(sapply(1:lf, function(i) rep(i,4)))
...
pdf("/users/ndyjack/Dist_Proj/figures_final/supfig_3.1.pdf",width=8,height=12)
...
write.csv(res,"/users/ndyjack/Dist_Proj/tables_final/suptab_5.1.csv",quote=F)
