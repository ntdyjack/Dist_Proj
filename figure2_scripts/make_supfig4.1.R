...
zleglabs <- c("0.30","0.44","0.58","0.72","0.86","1.00")
txtcut <- 0.50
...
pdf("/users/ndyjack/Dist_Proj/figures_final/supfig_4.1.pdf",width=8,height=12)
...
write.csv(res,"/users/ndyjack/Dist_Proj/tables_final/suptab_6.1.csv",quote=F)
