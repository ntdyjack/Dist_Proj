...
sh_script = '/users/ndyjack/Dist_Proj/scripts/qsub_mino.sh '
r_script = '/users/ndyjack/Dist_Proj/scripts/calc_hash.py '
...
for x in fnames:
  for i in idx_test:
    ...
    err = '-e ' + out_dir + name_tmp  + '.err '
    out = '-o ' + out_dir + name_tmp + '.out '
