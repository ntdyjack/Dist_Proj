...
results_dir <- "/users/ndyjack/Dist_Proj/tables/gplus/"
...
pdf("/users/ndyjack/Dist_Proj/images/gplus_plots.pdf")
heatmap3(t(results_sorted),scale="non",cexRow=0.8,cexCol=0.2,lasCol=1,Colv=NA,
  labCol=heatmap_labs)
...
#spaghetti plot
  ...
  mtext(side=2,text="Mean G+ (9 datasets)",cex=1.2,line=2.5,font=2,las=3)
