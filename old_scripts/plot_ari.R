...
results_dir <- "/users/ndyjack/Dist_Proj/tables/ari/"
...
pdf("/users/ndyjack/Dist_Proj/images/ari_plots.pdf")
...
#spaghetti plot
  ...
  mtext(side=2,text="Mean ARI (9 datasets)",cex=1.2,line=2.5,font=2,las=3)
