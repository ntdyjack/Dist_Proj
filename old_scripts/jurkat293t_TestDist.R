...
#make identity vector for jurkat vs 
labs <- read_excel("/users/ndyjack/Dist_Proj/tables/41467_2017_BFncomms14049_MOESM830_ESM.xlsx")
#all.equal(labs$`Cell Barcodes`,sce@colData$Barcode)
#gucci
labcols <- ifelse(labs$`Species Call by Expression`=="species1","blue","red")

#test case
#counts <- counts[,1:100]
#labcols <- labcols[1:100]
...
pdf("./images/jurkat293t_results_v1.pdf")
...
print(clust_acc)
save.image("/users/ndyjack/Dist_Proj/rdata/jurkat293t.rda")
