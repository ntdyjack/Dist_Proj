...
ylim_u <- c(-0.50,2.00)
yticks_u <- c(-0.50,0.00,0.50,1.00,1.50,2.00)
...
pdf("/users/ndyjack/Dist_Proj/figures_final/supfig_2.1.pdf",width=12,height=9)
...
write.csv(res_wu,"/users/ndyjack/Dist_Proj/tables_final/suptab_3.1.csv",quote=F)
write.csv(res_ws,"/users/ndyjack/Dist_Proj/tables_final/suptab_4.1.csv",quote=F)
