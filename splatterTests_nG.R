...
#nGene vector
nG_vec <- c(100,500,1000,2000,3000,6000,10000,15000,20000) 
...
output_file <- paste0("/users/ndyjack/Dist_Proj/rdata/splatterTests.nG.",args,".rda") 
